    ...
    <div className="grid" style={{ gap: 16 }}>
        ...
        <PanelSection title="Testimonials • Awards • Community">
          <div className="grid">
            <div className="card">
              ...
              <p>
                “Michael has completed several of my advanced courses, including
                Mobile App Development with React, Web Design and
                Implementation, and Machine Learning for Information
                Professionals. In each of these classes, he not only earned top
                grades but also stood out as one of the most engaged, capable,
                and self motivated students I have worked with. He consistently
                demonstrated strong technical skills, creative problem-solving,
                and the ability to grasp complex concepts with ease. ”
              </p>
              <p style={{ marginTop: 10 }}>— Yasser Youssef, Ph.D.</p>
              <p>
                “Michael quickly proved himself to be a reliable and thoughtful
                developer. He was able to take ideas and requirements and turn
                them into clean, functional features, while also paying close
                attention to usability and accessibility. He asks great
                questions, takes feedback seriously, and consistently delivers
                quality work. I appreciated how proactive he was in improving
                both the codebase and the overall user experience. ”
              </p>
        ...
        <AccordionGroup defaultOpenIndex={0}>
          ...
          >
            <div className="accordion-panel-content">
              ...
              <p>
                As a Software Engineer at The Church Studio, I helped design and
                build a cross-platform mobile application from the ground up to
          ...
          >
            <div className="accordion-panel-content">
              ...
              <p>
                As a Full-Stack Engineer at World Wide Technologies, I worked on
                building and maintaining web application features across both
                the front end and back end. I developed responsive user
                interfaces using modern JavaScript, HTML, and CSS while
                collaborating with team members to integrate server-side
                functionality. I assisted with API development and data handling
                to support dynamic application behavior. Throughout my role, I
                focused on writing clean, maintainable code and improving
                functionality based on feedback and testing.
              </p>
            </div>
          </AccordionItem>
        </AccordionGroup>
      ...
      <PanelSection title="Contact Me">
        <div className="card">
          ...
          <p>
            I’m actively seeking a full-time Junior Software Engineer role, or
            full-time Junior Full-Stack Engineer role, and I’m also open to
            freelance work and short-term collaborations where I can contribute,
            learn, and grow.
          </p>
          <div className="btn-row">
